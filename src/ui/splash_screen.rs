...
impl Plugin for MenuPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(
                Update,
                start_screen_input.run_if(in_state(TurnState::GameOver)),
            )
            ...
            .add_systems(
                Update,
                start_screen_input.run_if(in_state(TurnState::Victory)),
            )
            ...
            .add_systems(
                Update,
                start_screen_input.run_if(in_state(TurnState::NextLevel)),
            )
